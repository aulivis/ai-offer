...
const resourceIcons = [
  ...
  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" key="3">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
...
const resourceCategories: Array<'guide' | 'template' | 'article' | 'video'> = [
  'guide',
  'template',
  'article',
  'video',
...
export default function ResourcesSection() {
  const resources = [
    {
      title: t('landing.resources.items.0.title'),
      description: t('landing.resources.items.0.description'),
      href: resourceHrefs[0],
      icon: resourceIcons[0],
      category: resourceCategories[0],
    },
    {
      title: t('landing.resources.items.1.title'),
      description: t('landing.resources.items.1.description'),
      href: resourceHrefs[1],
      icon: resourceIcons[1],
      category: resourceCategories[1],
    },
    {
      title: t('landing.resources.items.2.title'),
      description: t('landing.resources.items.2.description'),
      href: resourceHrefs[2],
      icon: resourceIcons[2],
      category: resourceCategories[2],
    },
    {
      title: t('landing.resources.items.3.title'),
      description: t('landing.resources.items.3.description'),
      href: resourceHrefs[3],
