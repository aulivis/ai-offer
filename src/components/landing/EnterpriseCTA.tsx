        ...
        <div className="grid gap-8 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-4 text-lg leading-relaxed text-fg-muted">
              Testreszabott megoldások nagyobb csapatoknak, korlátlan ajánlatokkal és dedikált
              támogatással.
            </p>
            <ul className="mt-6 space-y-3">
              {[
                'Korlátlan ajánlatgenerálás',
                'Dedikált fiókkezelő',
                'Testreszabott számlázás',
                'Prioritásos támogatás',
                'SSO és egyedi integrációk',
              ].map((feature, index) => (
