export const hu = {
  ...
  chatbot: {
    title: 'Vyndi AI Aszisztens',
    welcomeTitle: 'Üdvözöllek! Hogyan segíthetek?',
    welcomeDescription: 'Kérdezz bármit a Vyndi funkcióiról, API-járól, sablonokról vagy a platform használatáról.',
    placeholder: 'Írd be a kérdésed...',
    thinking: 'Gondolkodás...',
    poweredBy: 'AI által működtetve',
    typing: 'Ír...',
    error: 'Hiba',
    send: 'Küldés',
    openAria: 'Chatbot megnyitása',
    closeAria: 'Chatbot bezárása',
