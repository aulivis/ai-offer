export const hu = {
  ...
  billing: {
    ...
    plans: {
      standard: {
        ...
        name: 'Vyndi Standard',
        description:
          '5 professzionális, márkázott PDF ajánlat havonta tételes árkalkulációval és logó feltöltéssel. Ideális kis csapatoknak és freelancereknek.',
        features: {
          0: '• 5 ajánlat / hónap',
          1: '• Márkázott PDF export logóval és színekkel',
          2: '• Alap sablonok + logó feltöltés',
          3: '• AI-alapú szöveg generálás magyar nyelven',
        },
        cta: 'Standard csomag aktiválása most',
      ...
      pro: {
        name: 'Vyndi Pro',
        description:
          'Korlátlan ajánlatgenerálás, prémium sablonok, márkázott PDF-ek és prioritásos támogatás. Ideális növekvő csapatoknak és vállalkozásoknak.',
        features: {
          0: '• Korlátlan ajánlat & verziókövetés',
          1: '• Márkázott PDF & prémium sablonkönyvtár',
    ...
    public: {
      badge: 'Előfizetés',
      hero: {
        title: 'Nyisd meg a Vyndi prémium élményét és zárj több projektet kevesebb idő alatt',
        description:
          'Fedezd fel, hogyan készíthetsz AI által támogatott, professzionális, márkázott PDF ajánlatokat percek alatt. Válaszd ki a csomagot, és lépj tovább az értékesítés következő szintjére. Akár 70%-os időmegtakarítás érhető el.',
  ...
  settings: {
    ...
    activities: {
      ...
      images: {
        ...
        description: '{current} / {max} kép feltöltve',
        add: 'Kép hozzáadása',
        uploading: 'Feltöltés…',
        maxReached: 'Maximum elérve',
        maxReachedDescription: 'Maximum {max} kép tölthető fel tevékenységenként.',
        invalidType: 'Érvénytelen fájltípus',
        invalidTypeDescription: 'Csak PNG vagy JPEG képek tölthetők fel.',
        tooLarge: 'Fájl túl nagy',
        tooLargeDescription: 'A fájl mérete legfeljebb 5 MB lehet.',
    ...
    guarantees: {
      ...
      helper: 'A garanciák az ajánlatkészítő 2. lépésében gyorsan bekapcsolhatók.',
      empty: 'Még nincs elmentett garanciád.',
      emptyHelper: 'Adj hozzá sablonokat, hogy gyorsabban töltsd ki az ajánlatokat.',
      textLabel: 'Garancia szövege',
      saveButton: 'Szöveg mentése',
      deleteButton: 'Törlés',
      saveSuccess: 'Garancia mentve',
      deleteSuccess: 'Garancia törölve',
      validationMessage: 'A garancia szövege nem lehet üres.',
      attachLabel: 'Kapcsolt tevékenységek',
      attachDisabled: 'Előbb adj hozzá tevékenységeket, hogy hozzárendelhesd őket.',
      attachHelper:
        'A kijelölt tevékenységeknél automatikusan felkínáljuk ezt a garanciát az ajánlatkészítőben.',
    },
    proFeatures: {
      title: 'Pro funkciók',
    ...
    testimonials: {
      ...
      activityLabel: 'Kapcsolódó tevékenység (opcionális)',
      noActivity: 'Nincs kapcsolódó tevékenység',
      unknownActivity: 'Ismeretlen tevékenység',
      add: 'Hozzáadás',
      saving: 'Mentés…',
      listTitle: 'Visszajelzések ({count} / {max})',
      linkedTo: 'Kapcsolódik',
      empty: 'Még nincs visszajelzés',
      emptyHelper: 'Adj hozzá visszajelzéseket az ügyfelektől',
      textRequired: 'A visszajelzés szövege kötelező',
      maxReached: 'Maximum elérve',
      maxReachedDescription: 'Maximum {max} visszajelzés menthető.',
      addSuccess: 'Visszajelzés sikeresen hozzáadva',
  ...
  landing: {
    ...
    hero: {
      ...
      spotlightDescription:
        'A Vyndi zökkenőmentesen illeszkedik a csapatod munkafolyamatába. Az ügyfeleid már az első ajánlattól kezdve prémium élményt kapnak, amely növeli az elfogadási arányt.',
      spotlightItems: [
        'AI-alapú szöveg generálás magyar nyelven, iparági sablonokkal',
        'Reszponzív, professzionális dizájn automatikus formázással',
        'Tételes árkalkuláció és bruttó/nettó összesítés automatikusan',
      ],
      pricing: {
    ...
    benefits: [
      {
        title: 'Egységes, professzionális megjelenés minden ajánlatnál',
        description:
          'A Vyndi automatikusan alkalmazza a márkád színeit és logóját minden generált PDF-ben. Sötét és világos témák támogatása. Minden ajánlat magabiztos, prémium hatást kelt, amely növeli az ügyfelek bizalmát.',
      },
      {
        title: 'Okos AI, ami érti a magyar nyelvet és a briefedet',
        description:
    ...
    howItWorks: {
      ...
      title: 'Három egyszerű lépés a professzionális ajánlathoz',
      ...
      steps: [
        {
          ...
          description:
            'Írd le a projekt részleteit, illessz be egy e-mailt, vagy válassz ki egy mentett sablont. Az AI azonnal kiemeli a lényeges pontokat és strukturált szövegeket készít.',
        },
        {
    ...
    emailCapture: {
      ...
      success: 'Sikeresen feliratkoztál!',
    },
    problemSection: {
      badge: 'A probléma',
      ...
      items: {
        0: {
          ...
          features: {
            ...
            2: 'Gyors sablonváltás és testreszabás',
          },
          cta: 'Próbáld ki most – ügynökségeknek',
        },
        1: {
          ...
          features: {
            ...
            2: 'Technikai leírások AI segítségével',
          },
    ...
    comparisonTable: {
      title: 'Vyndi vs. versenytársak',
      description: 'Nézd meg, mi teszi a Vyndi-t egyedivé az ajánlatkészítés terén',
      headerFeature: 'Funkció',
      headerVyndi: 'Vyndi',
      ...
      features: {
        ...
        brandedPdf: 'Márkázott PDF export',
        realtimeCollaboration: 'Valós idejű együttműködés',
        responsiveEditing: 'Reszponzív szerkesztés',
        freeTrial: 'Ingyenes próba',
        autoPricing: 'Automatikus árkalkuláció',
        interactiveFeedback: 'Interaktív visszajelzések',
      },
      values: {
        yes: '✓',
        no: '✗',
  ...
  login: {
    ...
    benefits: {
      ...
      subtitle: 'Ingyenes próba, azonnali hozzáférés, bankkártya nélkül. Kezdj el még ma.',
      items: {
        0: 'Automatikus fióklétrehozás – csak az e-mail címed kell, jelszó nélkül',
        1: 'Teljesen ingyenes kezdés – 2 professzionális ajánlat / hónap, bankkártya nélkül',
        2: 'Azonnali hozzáférés – percek alatt elkezdheted az AI-alapú ajánlatkészítést',
        3: 'Mesterséges intelligencia által generált, márkázott PDF ajánlatok percek alatt',
      },
    },
    trust: {
      noCreditCard: 'Nem szükséges bankkártya',
  ...
  offers: {
    wizard: {
      ...
      images: {
        ...
        inlineTitle: 'Referenciafotók a tételekhez',
        inlineDescription: 'Kattints a képekre, hogy be- vagy kikapcsold őket az ajánlatból.',
        inlineSelectedCount: 'Kiválasztva: {count}',
        activityHelper: '{count} fotó ehhez a tevékenységhez',
        activitySelectedCount: 'Aktív: {count}',
        viewFullSize: 'Megnyitás teljes méretben',
        orphanedTitle: 'Korábban kiválasztott fotók',
        orphanedDescription:
          'Ezek a képek már nem kapcsolódnak a jelenlegi tételekhez, de benne lesznek, amíg ki nem kapcsolod őket.',
      },
      guarantees: {
        sectionTitle: 'Előre definiált garanciák',
        sectionDescription: 'Kapcsold be a mentett garanciákat egy kattintással.',
        select: 'Hozzáadás',
        selected: 'Aktív',
        linkedActivities: 'Kapcsolt tevékenységek: {activities}',
        unlinked: 'Bármely tevékenységhez használható',
  ...
  errors: {
    ...
    initSession: {
      ...
      initializing: 'Munkamenet inicializálása…',
      success: 'Munkamenet kész',
      error: 'Munkamenet inicializálása sikertelen',
      errorDescription: 'Hiba történt a munkamenet beállítása során.',
      redirecting: 'Átirányítás a kezdőlapra…',
      redirectingToDashboard: 'Üdvözöllek! Átirányítás a vezérlőpultra…',
      pleaseWait: 'Kérjük, várj, amíg beállítjuk a munkamenetedet.',
      errorOccurred: 'Hiba történt a munkamenet inicializálása során.',
      redirectingToLogin: 'Átirányítás a bejelentkezési oldalra…',
    },
    settings: {
  ...
  pdf: {
    templates: {
      common: {
        ...
        dateLabel: 'Ajánlat dátuma',
        contactLabel: 'Kapcsolattartó',
        emailLabel: 'E-mail',
        phoneLabel: 'Telefon',
        websiteLabel: 'Weboldal',
        companyDetailsLabel: 'Cégadatok',
        addressLabel: 'Cím',
        taxIdLabel: 'Adószám',
        notProvided: '—',
        pageLabel: 'Oldal',
      ...
      sections: {
        ...
        valueProposition: 'Értékpropozíció',
        scope: 'Projekt terjedelem',
        deliverables: 'Szállítandók',
        expectedOutcomes: 'Várható eredmények',
        timeline: 'Ütemezés',
        assumptions: 'Feltételezések és kizárások',
        nextSteps: 'Következő lépések',
  ...
  chatbot: {
    ...
    send: 'Küldés',
    openAria: 'Vanda megnyitása',
    closeAria: 'Vanda bezárása',
